...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="trees row">
		<img src="https://www.evanjfarmer.com/wp-content/uploads/2016/10/blue-leaves.jpg" alt="Blue Leaves" width="1400" height="560" />
	</div>
	&nbsp;
	<div class="about entry-content">
		<div class="row">
  		<div class="services small-12 large-4 columns">
  			...
  			<hr>
  			<img src="https://www.evanjfarmer.com/wp-content/uploads/2016/09/evanandkoren.jpg" alt="Evan and Koren" width="300" height="300" /><hr>
  			<h4><i>our team</i></h4><hr>
      ...
      <hr>
  		...
  		<div class="services small-12 large-4 columns">
  			<h3>OFFERINGS</h3></a>
  			<hr>
  			<img src="https://www.evanjfarmer.com/wp-content/uploads/2016/09/EMap1.jpg" alt="Map" width="300" height="300"/><hr>
  			<h4><i>what we do</i></h4><hr>
